...
From your mac or PC:
1. Clone this sample
2. Copy `.env.template` to `.env` and update the file with the values for your container registry and unique module suffix and make sure that your docker engine has access to it
